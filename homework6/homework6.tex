...
\begin{parts}
\part Write a function with the declaration \verb$function x = jacobi(A,x0,b,tol)$ which implements the Jacobi method for solving a linear system of equations. Its inputs are the matrix \verb$A$, an initial guess \verb$x0$, the right-hand-side \verb$b$, and an absolute error tolerance \verb$tol$. Its output \verb$x$ is an approximate solution of the linear system.
