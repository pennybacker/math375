...
$f(x) = \frac{1}{1+x^2}$
using each of these three methods, taking $h = 1/2, 1/4, 1/8, 1/16, 1/32, 1/64$. Show the error for the methods as a function of $h$ on a single \verb$loglog$ plot. You can find the true solution analytically or by approximating the integral with a very small value of $h$. Hand in your plot and comment on the order of accuracy and cost of the methods.
